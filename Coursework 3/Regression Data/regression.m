...
TuningPerfList = [];
paraNums = 0; % the number of parameters need to be tuned in different kernel function
switch (svmtype)
    case "linear"
...
bestValue = zeros(1, paraNums+3); % best value use to save parameter value it choose and its performance
...
for i = 1:k
    ...
    % beginning of inner loop, for the iteration of outer loop to tune parameters   
    ...
    for j = 1:n
        ...
        % type of svm to work with if we want to tune polynomial
        ...
        % type of svm to work with if we want to tune linear
        else
            num = 0;
